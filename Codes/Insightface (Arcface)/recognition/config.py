...
dataset.CASIA_Bl= edict()
dataset.CASIA_Bl.dataset = 'CASIA_Bl'
dataset.CASIA_Bl.dataset_path = 'D:/03.DeepLearning/Dataset_Magister/ArcFace/Casia/CASIA-Bl-train'
dataset.CASIA_Bl.num_classes = 9518
dataset.CASIA_Bl.image_shape = (112,112,3)
dataset.CASIA_Bl.val_targets = ['lfw', 'agedb_30', 'Casia-Bl']

dataset.carnetsB = edict()
dataset.carnetsB.dataset = 'carnetsB'
dataset.carnetsB.dataset_path = 'D:/03.DeepLearning/Dataset_Magister/Carnets/Carnets_outputsB'
dataset.carnetsB.num_classes = 3152
dataset.carnetsB.image_shape = (112,112,3)
dataset.carnetsB.val_targets = ['lfw', 'cfp_fp', 'agedb_30']
...
default.end_epoch = 10            ####<<<<---------- tenia 10000
default.lr = 0.1
default.wd = 0.0005
default.mom = 0.9
### Originalmente era 64. Pero arroja el error:
### cudaMalloc retry failed: out of memory.
### Según issues del mismo repositorio, se debe disminuir el batch size.
default.per_batch_size = 16 ###<<<<<<<<-------
default.ckpt = 3
#default.lr_steps = '100000,160000,220000' #de insightface
default.lr_steps = '200000,280000,320000' # de vitor
